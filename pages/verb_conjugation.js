...
function App() {
  ...
  const getRandomQuizData = () => {
    ...
    return {
      ...
      conjugationToQuiz,
      correctAnswer: verb[conjugationToQuiz],
    };
  };
    ...
    <div>
      ...
      {quizData && (
        <div>
          ...
          <p>Conjugation to Quiz: {quizData.conjugationToQuiz}</p>
        ...
        <tbody>
          {VERB_CONJUGATIONS.map((verb, index) => (
            <tr key={index}>
              ...
              <td>{verb.negative}</td>
              <td>{verb.polite}</td>
              <td>{verb.polite_negative}</td>
              <td>{verb.past}</td>
              <td>{verb.past_negative}</td>
              <td>{verb.past_polite}</td>
              <td>{verb.past_polite_negative}</td>
              <td>{verb.te}</td>
            </tr>
          ))}
        </tbody>
